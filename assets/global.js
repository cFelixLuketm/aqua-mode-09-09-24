...
class VariantSelects extends HTMLElement {
  ...
  // filterMedia() {
  //   $('[thumbnail-color]').css("display", "none");
  ...
  //     $(selected_attribute).css("display", "block");
  //   }
  // }
...
// added
    ...
    if (disable) {
      ...
      // notifyMe.classList.add('active');
    } else {
      addButton.removeAttribute('disabled');
      // inventoryNote.innerHTML = "Add to bag";
      // preOrder.classList.remove('active');
      // notifyMe.classList.remove('active');

      // if (variantStock[this.currentVariant.id] > 0) {
      //   preOrder.classList.remove('active');
      //   inventoryNote.textContent = "Add to bag";
      //   notifyMe.classList.remove('active');
      // } else if (variantStock[this.currentVariant.id] < 1) {
      //   preOrder.classList.add('active');
      //   inventoryNote.textContent = "Pre order";
      //   notifyMe.classList.remove('active');
      // }
    }
